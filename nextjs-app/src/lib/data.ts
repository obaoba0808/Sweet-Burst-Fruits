...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    origin: '苗栗大湖草莓園',
    weight: '2盒組（共600g）',
    imageUrl: '/images/p2-strawberry.jpg',
    gallery: [
      '/images/p2-strawberry.jpg',
      '/images/hero-fruit.jpg'
    ],
  ...
  },
  {
    ...
    name: '金鑽鳳梨',
    tagline: '香甜不刺舌·台灣嚴選',
    description: '台灣金鑽鳳梨，果肉細緻，甜度高，纖維少。',
    longDescription: '來自台南的特級金鑽鳳梨，生長於亞熱帶的溫暖氣候中，日照充足、雨量適中。金鑽鳳梨以甜度高、酸味低、纖維少而聞名，果肉呈金黃色澤，口感綿密細緻，不用泡鹽水就能直接享用，是台灣最具代表性的水果之一。',
    price: 499,
    category: '當季鮮果',
    origin: '台南關山',
    weight: '每顆約3-4台斤',
    imageUrl: '/images/p4-pineapple.jpg',
    gallery: [
      '/images/p4-pineapple.jpg',
      '/images/hero-fruit.jpg'
    ],
    features: ['產地直送', '免浸鹽水', '甜而不膩']
  }
];
